...
\begin{center}
  ...
  {\color{inksoft}\normalsize For parents, caregivers, and grown-ups who help}\\[64pt]
  \begin{tikzpicture}
...
\begin{itemize}[leftmargin=16pt,itemsep=2pt]
  \item \textbf{She cannot break it.} Deleting is never permanent, settings live behind a
        grown-ups gate, and the app heals itself if the iPad misbehaves.
...
\begin{tikzpicture}[x=1cm,y=1cm]
  ...
  \node[lblsm] at (11.45,0.60) {Grown-ups: press and hold};
  % callouts
...
\begin{description}[leftmargin=26pt,labelwidth=18pt,itemsep=3pt,font=\normalfont]
  ...
  \item[\co{3}] \textbf{Help} rings a loud alarm so she can call a grown-up from another room.
        Only an adult can silence it. (Section 3)
  \item[\co{4}] \textbf{Hello} simply says ``hello'' — a safe, friendly button to experiment with.
  \item[\co{5}] \textbf{Grown-ups: press and hold.} Hold for about three seconds to open the
...
\begin{description}[leftmargin=26pt,labelwidth=18pt,itemsep=3pt,font=\normalfont]
  ...
  \item[\co{2}] \textbf{Clear} empties the sentence bar. Nothing else changes.
  \item[\co{3}] \textbf{The group strip.} One colored button per word group; the group she
        is in has the darker outline. She moves between groups herself — no grown-up needed.
...
\begin{itemize}[leftmargin=16pt,itemsep=2pt]
  ...
  \item A small reminder banner stays on the home screen until a grown-up clears it,
...
On the home screen, press and hold \textbf{Grown-ups: press and hold} for about three

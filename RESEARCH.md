...
**Universal Core vocabulary (36 words) plus a transparent extension.** Core Words preserves the exact 36-word Universal Core set: all, can, different, do, finished, get, go, good, he, help, here, I, in, it, like, look, make, more, not, on, open, put, same, she, some, stop, that, turn, up, want, what, when, where, who, why, you. Developed by Project Core, Center for Literacy and Disability Studies, UNC Chapel Hill; licensed CC BY 4.0. Sources: [Project Core communication systems](https://project-core.com/communication-systems/), [UNC CLDS Universal Core page](https://www.med.unc.edu/healthsciences/clds/universal-core-vocabulary/). Project Core describes these 36 as a small universally useful system, not a complete English grammar. Nuran therefore labels its additional group **Sentence Words** rather than attributing those words to Project Core.

**Sentence-building extension.** The extension covers common categories that were absent from the 36-word board: `am/is/are`; articles `a/the`; conjunctions `and/but/because/or`; additional pronouns and determiners; common verbs; relational words; `how`; and time/description words. This is a starter completeness contract, not an individualized clinical prescription. A 2024 aided-language review notes that core lists derived from typical speakers commonly include articles, pronouns, prepositions, `am/are/is`, and action verbs ([open-access article](https://pmc.ncbi.nlm.nih.gov/articles/PMC11000798/)). AssistiveWare similarly describes robust core vocabulary as spanning verbs, adjectives, prepositions, pronouns, articles, and conjunctions, alongside fringe vocabulary and the alphabet ([core-word guidance](https://www.assistiveware.com/learn-aac/learn-about-core-word-teaching-strategies)).
